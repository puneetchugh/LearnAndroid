...
public class SingleTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1 = (Button) findViewById(R.id.singletask_button_single_instance);
        Button button2 = (Button) findViewById(R.id.singletask_button_single_task);
        Button button3 = (Button) findViewById(R.id.singletask_single_top);
        Button button4 = (Button) findViewById(R.id.singletask_standard);
